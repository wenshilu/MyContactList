...
//  MyContactList
//
//  Created by Wenshi Lu on 4/27/19.
...
//        loadDataFromDatabase()
    ...
    func loadDataFromDatabase() {
        ...
        let sortDescriptorArray = [sortDescriptor]
            // to sort by multiply fields, add more sort descriptors to the array
    ...
    */
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let actionHandler = {
            (action:UIAlertAction!) -> Void in self.performSegue(withIdentifier: "EditContact", sender: tableView.cellForRow(at: indexPath))
...
//        let actionDetails = UIAlertAction(title: "Show Details", style: .default)
